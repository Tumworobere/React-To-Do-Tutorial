...
An application that lets you organize your task.
...
```
npx create-react-app React-To-Do-Tutorial
cd math-magician
npm start
```
## Getting Started
**To clone this project**
**Run command: $git clone  https://github.com/Tumworobere/React-To-Do-Tutorial.git**
